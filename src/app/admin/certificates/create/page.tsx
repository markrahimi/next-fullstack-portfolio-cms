  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(`Failed to create certificate: ${error.error || "Unknown error"}`);
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Create Certificate</h1>
            <p className="text-gray-400">Add a new certificate or certification</p>
          </div>
        </div>
