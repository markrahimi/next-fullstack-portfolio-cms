...
export default function EditExperience() {
  ...
  const [formData, setFormData] = useState<ExperienceFormData | null>(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 py-8">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Edit Experience</h1>
          <p className="text-gray-400">Update work experience details</p>
        </div>
